...
//
// Lúc viết tệp này `GridTable.tsx` có BỐN đường chèn/xoá (đường `addSubAfter` — nút "↳ thêm hàng
// con" — đã bỏ 2026-09-23). Ba đường (`pushItem`, `addSubAfter`, `removeRow`) gọi hàm

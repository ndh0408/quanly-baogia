...
import {
  fmtMoney, quoteTotals, vnDateText, escapeHtml,
  groupLetter, sheetSubtotalGrouped,
  statusLabel, ROLE_LABEL, ROLE_LABEL_FULL,
} from "./js/util.js?v=20260619";
...
import {
  state, can, landingPage, sheetUsesDays, clearDaysIfUnused,
...
import { api, setUnauthorizedHandler } from "./js/core/api.js?v=20260619";
// UI primitives (step 4): toasts, skeletons, modals, theme, keyboard activation, inline
// field errors. Leaf module (only depends on escapeHtml) — no state/api/render.
import {
  toast, skeleton, KBD, installKeyActivation, applyFieldErrors,
  initTheme, toggleTheme, openModal, promptModal, confirmModal,
} from "./js/ui.js?v=20260619";
// Live xlsx-faithful preview (step 5). Editor calls refreshPreview() on each edit.
import { refreshPreview } from "./js/preview.js?v=20260619";
...
} from "./js/pages/quotes.js?v=20260619";

...
import { fmtMoney, fmtDate, escapeHtml, safeLogoSrc, statusLabel, ROLE_LABEL } from "../util.js?v=20260622n";
import { state, can, canOnQuote } from "../core/state.js?v=20260622n";
import { api } from "../core/api.js?v=20260622n";
import { toast, skeleton, KBD, errorState, confirmModal } from "../ui.js?v=20260622n";
import { pickCustomer } from "./admin.js?v=20260622n";

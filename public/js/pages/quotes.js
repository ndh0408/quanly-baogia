...
import { fmtMoney, fmtDate, escapeHtml, safeLogoSrc, statusLabel, ROLE_LABEL } from "../util.js?v=20260622m";
import { state, can, canOnQuote } from "../core/state.js?v=20260622m";
import { api } from "../core/api.js?v=20260622m";
import { toast, skeleton, KBD, errorState, confirmModal } from "../ui.js?v=20260622m";
import { pickCustomer } from "./admin.js?v=20260622m";

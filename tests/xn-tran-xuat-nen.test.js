...
describe("Ân hạn dừng phải BAO ĐƯỢC trần sinh file của đường nền", () => {
  ...
  // Compose: đọc ĐÚNG khối service `worker` — từ audit 2026-09-22 (INFRA-10) service app cũng khai
  // stop_grace_period (30s), và nó đứng TRƯỚC worker trong tệp, nên regex trần sẽ bắt nhầm số của app.

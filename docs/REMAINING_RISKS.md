...
| Bài kiểm mức component (jsdom, opt-in) | `web/src/components/GridTable.component.test.tsx` — **44 bài** |
...
| Phím tắt Ctrl+Z · Ctrl+Y · Ctrl+Shift+Z (hỏi `undoRedoKey`) | `web/src/components/GridTable.tsx` (grep `undoRedoKey`) |

...
> §9 đòi *chuẩn bị* kiến trúc `/api/v1/`, **không** đòi viết lại 142 endpoint chỉ để gắn số. Và nó
...
Một bề mặt API thứ hai **không phải là một dòng cấu hình**: nó là 142 endpoint nữa phải nằm trong

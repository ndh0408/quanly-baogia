...
|---|---|---|
| KEEP | 33 | Không có vấn đề đo được nào biện minh cho việc thay. Hai trong số này là **KEEP (chưa kích hoạt)** — Helm/k8s và 22 rule cảnh báo: có file, chưa phải thứ đang chạy. |

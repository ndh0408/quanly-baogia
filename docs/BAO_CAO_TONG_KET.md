...
| Lệnh | Kết quả |
|---|---|
| `npx vitest run` (backend) | **182 tệp** — đo 2026-09-07. Đợt này thêm `tests/projectref-sheet-discount.test.js` (Discount ở mức sheet: trang Nhân sự và trang Quản lý dự án phải ra CÙNG một số); chạy riêng nó: **4 bài xanh**, không cần hạ tầng |

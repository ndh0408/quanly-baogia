#!/bin/sh
# Phần chạy BÊN TRONG container node cho scripts/migration-rehearsal.sh. Tách file để tránh lồng
...
node --import tsx scripts/migration-rehearsal-seed.mjs || FAIL=1
...
node --import tsx scripts/migration-rehearsal-check.mjs || FAIL=1
